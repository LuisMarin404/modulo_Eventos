...
import com.entidades.bean.ServiciosFacade;
...
public class ServiciosController implements Serializable {
    ...
    @EJB
    private com.entidades.bean.ServiciosFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Lang/Bundle").getString("ServiciosCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Lang/Bundle").getString("ServiciosUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Lang/Bundle").getString("ServiciosDeleted"));
        if (!JsfUtil.isValidationFailed()) {
