...
import com.entidades.bean.PerfilFacade;
...
public class PerfilController implements Serializable {
    ...
    @EJB
    private com.entidades.bean.PerfilFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Lang/Bundle").getString("PerfilCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Lang/Bundle").getString("PerfilUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Lang/Bundle").getString("PerfilDeleted"));
        if (!JsfUtil.isValidationFailed()) {
