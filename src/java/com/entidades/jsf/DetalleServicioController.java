...
import com.entidades.bean.DetalleServicioFacade;
...
public class DetalleServicioController implements Serializable {
    ...
    @EJB
    private com.entidades.bean.DetalleServicioFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Lang/Bundle").getString("DetalleServicioCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Lang/Bundle").getString("DetalleServicioUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Lang/Bundle").getString("DetalleServicioDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public static class DetalleServicioControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof DetalleServicio) {
                ...
                return getStringKey(o.getIdDetallServ());
            } else {
