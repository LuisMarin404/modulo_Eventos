...
import com.entidades.bean.ReservaFacade;
...
public class ReservaController implements Serializable {
    ...
    @EJB
    private com.entidades.bean.ReservaFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Lang/Bundle").getString("ReservaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Lang/Bundle").getString("ReservaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Lang/Bundle").getString("ReservaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
