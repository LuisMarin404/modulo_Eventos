...
import com.entidades.bean.MenuFacade;
...
public class MenuController implements Serializable {
    ...
    @EJB
    private com.entidades.bean.MenuFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Lang/Bundle").getString("MenuCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Lang/Bundle").getString("MenuUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Lang/Bundle").getString("MenuDeleted"));
        if (!JsfUtil.isValidationFailed()) {
